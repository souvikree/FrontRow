...
const Dashboard = () => {
  return (
    <div>
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-56 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <a className="flex items-center p-2 text-gray-900 dark:text-white">
                <svg
            ...
            <Link to='/admin/dashboard/adminhome'>
              ...
              <Link to="/admin/dashboard/movie">
            <li>
                <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <Icon icon="fluent:movies-and-tv-16-filled" width={23} />
                  <span className="ms-3 whitespace-nowrap">Movie</span>
                </a>
            </li>
              </Link>
