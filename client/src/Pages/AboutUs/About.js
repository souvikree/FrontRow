...
import { faFilm, faTicketAlt, faStar } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className='grid grid-cols-2 gap-x-10 px-5 md:px-16'>
        ...
        <div className='flex flex-col h-screen justify-center'>
          ...
          <p className='text-left pl-10 text-xl font-semibold text-gray-700 mt-6'>
            Welcome to Front Row, your premier movie booking platform. 
            We offer an <span className="inline-flex items-center"><FontAwesomeIcon icon={faFilm} className="mr-2" />intuitive</span> and <span className="inline-flex items-center"><FontAwesomeIcon icon={faStar} className="mr-2" />user-friendly</span> experience, 
